...
export let uploadFile=async (pickedFile)=>{
  ...
  let wannaUpFile = { name:pickedFile.name, type:pickedFile.mimeType, uri:pickedFile.uri,size:pickedFile.size };
  console.log("upload return wannafile",wannaUpFile);
  try{
